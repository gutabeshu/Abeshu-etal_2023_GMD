...
class Calibrate:
    ...
    def calibrate_basin(self, popsize=15, polish=False):
        ...
        he = ABCD(pars, self.bsn_PET, self.bsn_P, self.bsn_TMIN, 
                  target_basin_ids, self.n_months, self.runoff_spinup, method='dist')
        he.emulate()
        runoff_optimal = he.rsim.T
        np.save('{}/{}_runoff_optimal_{}.npy'.format(self.out_dir, 'runoff_optimal', self.basin_num), runoff_optimal)        
